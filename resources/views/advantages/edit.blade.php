                                                    ...
                                                    <div class="tab-content" id="pills-tabContent">
                                                        <div class="tab-pane fade show active" id="pills-home"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control" id="editor1" name="content_uz">{{ $advantages->content_uz}}</textarea>
                                                            </div>
                                                        </div>
                                                        <div class="tab-pane fade" id="pills-profile" role="tabpanel"
                                                            ...
                                                            <div class="form-group">
                                                                <label for="name_uz"> To'liq</label>
                                                                <textarea class="form-control" id="editor2" name="content_ru">{{ $advantages->content_ru }}</textarea>
                                                            </div>
                                                        </div>
                                                        <div class="tab-pane fade" id="pills-profile22" role="tabpanel"
                                                            ...
                                                            <div class="form-group">
                                                                <label for="name_uz"> To'liq</label>
                                                                <textarea class="form-control" id="editor3" name="content_en">{{ $advantages->content_en }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
