		...
		<div class="container-fluid">
			...
			<div class="row mt-3">
				<div class="col-lg-12">
					<div class="card">
						<div class="card-body">
							<h5 class="card-title"><a class="" href="{{ route('statistic.index') }}"><i
										...
										<div class="tab-content" id="pills-tabContent">
											...
											<div class="tab-pane fade" id="title_marriages_uz" role="tabpanel" aria-labelledby="pills-contact-tab">
												<div class="form-group">
													...
													<input type="text" class="form-control" maxlength="300"  name="title_marriages_uz">
												</div>
												<div class="form-group">
													<label for="exampleInputEmail1">Soni-uz</label>
													<input type="text" class="form-control" maxlength="300"  name="count_marriages_uz">
												</div>
											</div>
											<div class="tab-pane fade" id="title_marriages_ru" role="tabpanel" aria-labelledby="pills-contact-tab">
												<div class="form-group">
													...
													<input type="text" class="form-control" maxlength="300"  name="title_marriages_ru">
												</div>
												<div class="form-group">
													<label for="exampleInputEmail1">Soni-ru</label>
													<input type="text" class="form-control" maxlength="300"  name="count_marriages_ru">
												</div>
											</div>
											...
											<div class="tab-pane fade" id="title_born_uz" role="tabpanel" aria-labelledby="pills-contact-tab">
												<div class="form-group">
													...
													<input type="text" class="form-control" maxlength="300"  name="title_born_uz">
												</div>
												<div class="form-group">
													<label for="exampleInputEmail1">Soni-uz</label>
													<input type="text" class="form-control" maxlength="300"  name="count_born_uz">
												</div>
											</div>
											<div class="tab-pane fade" id="title_born_ru" role="tabpanel" aria-labelledby="pills-contact-tab">
												<div class="form-group">
													...
													<input type="text" class="form-control" maxlength="300"  name="title_born_ru">
												</div>
												<div class="form-group">
													<label for="exampleInputEmail1">soni-ru</label>
													<input type="text" class="form-control" maxlength="300"  name="count_born_ru">
												</div>
											</div>
											<div class="tab-pane fade" id="title_happy_uz" role="tabpanel" aria-labelledby="pills-contact-tab">
												<div class="form-group">
													...
													<input type="text" class="form-control" maxlength="300"  name="title_happy_uz">
												</div>
												<div class="form-group">
													<label for="exampleInputEmail1">Soni-uz</label>
													<input type="text" class="form-control" maxlength="300" name="count_happy_uz">
												</div>
											</div>
											<div class="tab-pane fade" id="title_happy_ru" role="tabpanel" aria-labelledby="pills-contact-tab">
												<div class="form-group">
													...
													<input type="text" class="form-control" maxlength="300"  name="title_happy_ru">
												</div>
												<div class="form-group">
													<label for="exampleInputEmail1">soni-ru</label>
													<input type="text" class="form-control" maxlength="300"  name="count_happy_ru">
												</div>
											</div>
