                                                    ...
                                                    <div class="tab-content" id="pills-tabContent">
                                                        <div class="tab-pane fade show active" id="pills-home"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" value="{{ $staff->name_uz }}" required name="name_uz" class="form-control" id="name_uz" >
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="name_uz"> Lavozimi</label>
                                                                <input type="text" value="{{ $staff->position_uz }}" required name="position_uz" class="form-control" id="name_uz" >
                                                            </div>
                                                        </div>
                                                        <div class="tab-pane fade" id="pills-profile" role="tabpanel"
                                                             ...
                                                             <div class="form-group">
                                                                <label for="name_uz">Ismi</label>
                                                                <input type="text" value="{{ $staff->name_ru}}" name="name_ru" class="form-control" id="name_uz" >
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="name_uz"> Lavozimi</label>
                                                                <input type="text" value="{{ $staff->position_ru}}" name="position_ru" class="form-control" id="name_uz" >
                                                            </div>
                                                        </div>
                                                        <div class="tab-pane fade" id="pills-profile22" role="tabpanel"
                                                            ...
                                                            <div class="form-group">
                                                                <label for="name_uz">Ismi</label>
                                                                <input type="text" value="{{ $staff->name_en }}" name="name_en" class="form-control" id="name_uz" >
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="name_uz"> Lavozimi</label>
                                                                <input type="text" value="{{ $staff->position_en }}" name="position_en" class="form-control" id="name_uz" >
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="meta_description_ru">Telefoni</label>
                                                            <input type="text" name="phone" value="{{ $staff->phone }}" class="form-control"   id="meta_description_ru" >
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="meta_description_ru">Email</label>
                                                            <input type="text" name="email" value="{{ $staff->email }}" class="form-control"   id="meta_description_ru" >
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
