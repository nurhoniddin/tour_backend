										...
										<div class="tab-content" id="pills-tabContent">
											<div class="tab-pane fade show active" id="pills-home"
												...
												<div class="form-group">
													...
													<input type="text" name="address_uz" class="form-control" id="address_uz">
												</div>
											...
											<div class="tab-pane fade" id="pills-profile" role="tabpanel"
												...
												<div class="form-group">
													...
													<input type="text" name="address_ru" class="form-control" id="address_ru">
												</div>
											</div>
										</div>
										<div class="form-group">
											<label for="work_day">Ish vaqti <i class="fa fa-clock-o" style="font-size: 17px"></i></label>
											<input type="text" name="work_day" class="form-control" id="work_day">
										</div>
										<div class="form-group">
