				...
				<div class="col-lg-12">
					<div class="card">
						<div class="card-body">
							...
							<div class="row mt-3">
								<div class="col-lg-12">
									<form action="{{ route('urik.update',$urik->id) }}" method="post" enctype="multipart/form-data">
										@csrf
										@method('PATCH')
										...
										<div class="tab-content" id="pills-tabContent">
											<div class="tab-pane fade show active" id="pills-home"
												...
												<div class="form-group">
													...
													<input type="text" name="title_uz" maxlength="50" required value="{{ $urik->title_uz }}" class="form-control" id="name_uz" >
												</div>
												<div class="form-group">
											...
											<div class="tab-pane fade" id="pills-profile" role="tabpanel"
												...
												<div class="form-group">
													<label for="name_uz">mavzu</label>
													<input type="text" name="title_ru" value="{{ $urik->title_ru }}" maxlength="50" class="form-control" id="name_uz" >
												</div>
												<div class="form-group">
													<label for="description_ru">description</label>
											...
											<div class="tab-pane fade" id="pills-profile22" role="tabpanel"
												...
												<div class="form-group">
													<label for="name_uz">mavzu</label>
													<input type="text" name="title_en" value="{{ $urik->title_en }}" maxlength="50" class="form-control" id="name_uz" >
												</div>
												<div class="form-group">
