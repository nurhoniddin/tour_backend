										...
										<div class="tab-content" id="pills-tabContent">
											<div class="tab-pane fade show active" id="pills-home"
												...
												<div class="form-group">
													...
													<input type="text" name="title_uz" value="{{ $decision->title_uz }}" required class="form-control" id="name_uz">
												</div>

												<div class="form-group">
													<label for="name_uz">link_uz</label>
													<input type="text" name="link_uz" value="{{ $decision->link_uz }}" required class="form-control" id="name_uz">
												</div>
											...
											<div class="tab-pane fade" id="pills-profile" role="tabpanel"
												...
												<div class="form-group">
													...
													<input type="text" name="title_ru" value="{{ $decision->title_ru }}" class="form-control" id="name_ru">
												</div>

												<div class="form-group">
													<label for="name_ru">link_ru</label>
													<input type="text" name="link_ru" value="{{ $decision->link_ru }}" class="form-control" id="name_ru">
												</div>
											...
											<div class="tab-pane fade" id="pills-profile22" role="tabpanel"
												...
												<div class="form-group">
													...
													<input type="text" name="title_en" value="{{ $decision->title_en }}" class="form-control" id="name_ru">
												</div>

												<div class="form-group">
													<label for="name_ru">link_en</label>
													<input type="text" name="link_en" value="{{ $decision->link_en }}" class="form-control" id="name_ru">
												</div>
